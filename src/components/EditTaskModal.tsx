...
import { Task, TaskCategory, RecurrenceType, TimeOfDay, TASK_EMOJIS, WEEKDAYS, TIME_OF_DAY } from '@/types';
...
export function EditTaskModal({ isOpen, task, onClose, onSubmit }: EditTaskModalProps) {
  ...
  useEffect(() => {
    if (task) {
      ...
      setDayOfWeek(task.recurrence.dayOfWeek || 1);
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {/* Info about assigned people */}
          <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-600">
            <p className="flex items-center gap-2">
              <span>ℹ️</span>
              Para alterar as pessoas atribuidas, exclua a tarefa e crie uma nova.
            </p>
          </div>
